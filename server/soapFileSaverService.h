...
#include "soapH.h"
    ...
    class SOAP_CMAC FileSaverService : public soap {
      public:
        ...
        //
        /// Web service operation 'findPath' implementation, should return SOAP_OK or error code
        virtual int findPath(struct soap *soap, int x, int y, int *result) SOAP_PURE_VIRTUAL;
    };
#endif
