...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.132 2024-07-12 12:19:35 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_ns__findPath:
		return soap_in_ns__findPath(soap, tag, NULL, "ns:findPath");
	case SOAP_TYPE_ns__findPathResponse:
		return soap_in_ns__findPathResponse(soap, tag, NULL, "ns:findPathResponse");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "ns:findPath"))
		{	*type = SOAP_TYPE_ns__findPath;
			return soap_in_ns__findPath(soap, tag, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns:findPathResponse"))
		{	*type = SOAP_TYPE_ns__findPathResponse;
			return soap_in_ns__findPathResponse(soap, tag, NULL, NULL);
		}
...
{	(void)tag;
	...
	case SOAP_TYPE_ns__findPath:
		return soap_out_ns__findPath(soap, tag, id, (const struct ns__findPath *)ptr, "ns:findPath");
	case SOAP_TYPE_ns__findPathResponse:
		return soap_out_ns__findPathResponse(soap, tag, id, (const struct ns__findPathResponse *)ptr, "ns:findPathResponse");
	case SOAP_TYPE_PointerToint:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_std__wstring:
		...
		break;
	case SOAP_TYPE_ns__findPath:
		soap_serialize_ns__findPath(soap, (const struct ns__findPath *)ptr);
		break;
	case SOAP_TYPE_ns__findPathResponse:
		soap_serialize_ns__findPathResponse(soap, (const struct ns__findPathResponse *)ptr);
		break;
	case SOAP_TYPE_PointerToint:
...
{	(void)type;
	...
	case SOAP_TYPE_ns__findPathResponse:
		return (void*)soap_instantiate_ns__findPathResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_ns__findPath:
		return (void*)soap_instantiate_ns__findPath(soap, -1, type, arrayType, n);
#ifndef WITH_NOGLOBAL
...
SOAP_FMAC3 int SOAP_FMAC4 soap_fdelete(struct soap *soap, struct soap_clist *p)
{
	...
	case SOAP_TYPE_ns__findPathResponse:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct ns__findPathResponse*>(p->ptr), struct ns__findPathResponse);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct ns__findPathResponse*>(p->ptr), struct ns__findPathResponse);
		break;
	case SOAP_TYPE_ns__findPath:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct ns__findPath*>(p->ptr), struct ns__findPath);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct ns__findPath*>(p->ptr), struct ns__findPath);
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_finsert(struct soap *soap, int t, int tt, void *p, size_t index, const void *q, void **x)
{
	...
	case SOAP_TYPE_ns__loadFileResponse:
		...
		*(ns__loadFileResponse*)p = *(ns__loadFileResponse*)q;
		break;
	case SOAP_TYPE_ns__findPathResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct ns__findPathResponse type=%d location=%p object=%p\n", t, p, q));
		*(struct ns__findPathResponse*)p = *(struct ns__findPathResponse*)q;
		break;
	case SOAP_TYPE_ns__findPath:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct ns__findPath type=%d location=%p object=%p\n", t, p, q));
		*(struct ns__findPath*)p = *(struct ns__findPath*)q;
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__findPath(struct soap *soap, struct ns__findPath *a)
{
	a->soap = soap;
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__findPath(struct soap *soap, const struct ns__findPath *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_embedded(soap, &a->x, SOAP_TYPE_int);
	soap_embedded(soap, &a->y, SOAP_TYPE_int);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__findPath(struct soap *soap, const char *tag, int id, const struct ns__findPath *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__findPath), type))
		return soap->error;
	if (soap_out_int(soap, "x", -1, &a->x, ""))
		return soap->error;
	if (soap_out_int(soap, "y", -1, &a->y, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}

SOAP_FMAC3 struct ns__findPath * SOAP_FMAC4 soap_in_ns__findPath(struct soap *soap, const char *tag, struct ns__findPath *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	(void)type; /* appease -Wall -Werror */
	a = (struct ns__findPath*)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__findPath, sizeof(struct ns__findPath), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__findPath(soap, a);
	if (soap->body && *soap->href != '#')
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_x && soap->error == SOAP_TAG_MISMATCH)
			{	if (soap_in_int(soap, "x", &a->x, "xsd:int"))
				{	soap_flag_x--;
					continue;
				}
			}
			if (soap_flag_y && soap->error == SOAP_TAG_MISMATCH)
			{	if (soap_in_int(soap, "y", &a->y, "xsd:int"))
				{	soap_flag_y--;
					continue;
				}
			}
		...
		if (soap_element_end_in(soap, tag))
			return NULL;
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_x > 0 || soap_flag_y > 0))
		{	soap->error = SOAP_OCCURS;
			return NULL;
		}
	}
	...
	{	a = (struct ns__findPath *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__findPath, SOAP_TYPE_ns__findPath, sizeof(struct ns__findPath), 0, soap_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__findPath * SOAP_FMAC2 soap_instantiate_ns__findPath(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__findPath(%p, %d, %s, %s)\n", (void*)soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct ns__findPath *p;
	size_t k = sizeof(struct ns__findPath);
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE_ns__findPath, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct ns__findPath);
		if (p)
			p->soap = soap;
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct ns__findPath, n);
		k *= n;
		if (p)
			for (int i = 0; i < n; i++)
				p[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns__findPath location=%p n=%d\n", (void*)p, n));
	if (size)
		*size = k;
	if (!p)
		soap->error = SOAP_EOM;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__findPath(struct soap *soap, const struct ns__findPath *a, const char *tag, const char *type)
{
	if (soap_out_ns__findPath(soap, tag ? tag : "ns:findPath", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct ns__findPath * SOAP_FMAC4 soap_get_ns__findPath(struct soap *soap, struct ns__findPath *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__findPath(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__findPathResponse(struct soap *soap, struct ns__findPathResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->result = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__findPathResponse(struct soap *soap, const struct ns__findPathResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__findPathResponse(struct soap *soap, const char *tag, int id, const struct ns__findPathResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__findPathResponse), type))
		return soap->error;
...
SOAP_FMAC3 struct ns__findPathResponse * SOAP_FMAC4 soap_in_ns__findPathResponse(struct soap *soap, const char *tag, struct ns__findPathResponse *a, const char *type)
{
	size_t soap_flag_result = 1;
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	(void)type; /* appease -Wall -Werror */
	a = (struct ns__findPathResponse*)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__findPathResponse, sizeof(struct ns__findPathResponse), NULL, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_ns__findPathResponse(soap, a);
	if (soap->body && *soap->href != '#')
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct ns__findPathResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__findPathResponse, SOAP_TYPE_ns__findPathResponse, sizeof(struct ns__findPathResponse), 0, soap_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns__findPathResponse * SOAP_FMAC2 soap_instantiate_ns__findPathResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__findPathResponse(%p, %d, %s, %s)\n", (void*)soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct ns__findPathResponse *p;
	size_t k = sizeof(struct ns__findPathResponse);
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE_ns__findPathResponse, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct ns__findPathResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct ns__findPathResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns__findPathResponse location=%p n=%d\n", (void*)p, n));
	if (size)
		*size = k;
	if (!p)
		soap->error = SOAP_EOM;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__findPathResponse(struct soap *soap, const struct ns__findPathResponse *a, const char *tag, const char *type)
{
	if (soap_out_ns__findPathResponse(soap, tag ? tag : "ns:findPathResponse", -2, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct ns__findPathResponse * SOAP_FMAC4 soap_get_ns__findPathResponse(struct soap *soap, struct ns__findPathResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_ns__findPathResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
